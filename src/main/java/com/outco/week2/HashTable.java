...
class MainHTable {
    ...
    public static void main(String[] args) {
        ...
        assertTest(testCount, "default storage set to an arraylist", new Test() {
            public boolean execute() {
                HashTable hashTable = new HashTable();
